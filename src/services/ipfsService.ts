...
export class IPFSService {
  ...
  constructor() {
    // 从环境变量获取Pinata配置
    this.pinataApiKey = process.env.REACT_APP_PINATA_API_KEY || '3a130e6275d907d72f0b';
    this.pinataSecretKey = process.env.REACT_APP_PINATA_SECRET_KEY || '36a5e4d3c24c6651100b5d4784417a1f82fec6eece08f95f636ada96a16fdeb5';
